...
int main()
{
    ...
    tend = clock();
    printf("time for prime generation %f\n",double(tend-tstart)/CLOCKS_PER_SEC );
    tstart=tend;
    ...
    tend = clock();
    printf("time for square generation %f\n",double(tend-tstart)/CLOCKS_PER_SEC );
    tstart = tend;
    ...
    tend = clock();
    printf("time before each radius check %f\n",double(tend-tstart)/CLOCKS_PER_SEC );
    tstart = tend;
    ...
    printf("%f %f %f %f\n", (double)t1/CLOCKS_PER_SEC, (double)t2/CLOCKS_PER_SEC, (double)t3/CLOCKS_PER_SEC, (double)t4/CLOCKS_PER_SEC);
    printf("%30.15f %d\n", total, cnt);
}
